<?php /* Smarty version Smarty-3.1.7, created on 2013-05-19 02:09:10
...
" class="user" type="text" placeholder="人数，例如：20" />
                ...
                <tr id="faculty_choose" <?php if ($_smarty_tpl->tpl_vars['facultylimit']->value==1){?> style="display:block" <?php }?> >
                    <th></th>
                    <td>
...
" name="faculty_choose" <?php echo $_smarty_tpl->tpl_vars['faculty']->value['limit'];?>
 >
                ...
                <tr id="en_choose" <?php if ($_smarty_tpl->tpl_vars['facultylimit']->value==1){?>style="display:block"<?php }?>>
                <th></th>
                <td>
