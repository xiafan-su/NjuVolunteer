<?php /* Smarty version Smarty-3.1.7, created on 2013-05-30 20:36:39
...
<div class="main">
		<div class="span_left">
                ...
                <tr>
					<th>活动名称</th>
					<td>
						<input id="activity_name" name="activity_name" class="user" type="text" placeholder="活动名称，45字以内" onblur="test_act_name()"/> 
                    </td>
                    <td>   
