<?php /* Smarty version Smarty-3.1.7, created on 2013-05-17 21:34:07
         compiled from "../tpls/templates\include\rec_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:124505195d40d5cac39-17821640%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '124505195d40d5cac39-17821640',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5195d40d7c7e6',
  'variables' => 
  array (
    'update_time' => 0,
    'activity_name' => 0,
...
<?php if ($_valid && !is_callable('content_5195d40d7c7e6')) {function content_5195d40d7c7e6($_smarty_tpl) {?>
...
" onclick="change_rec_edit_head_checkbox();"
				...
				/></td>
				<td>
					<span noid="<?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['id'];?>
" title="点击查看该学生信息" ><?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['id'];?>
				...
				<td>
					<span title="点击修改" class="doc_time"  onclick = "change_doc_time_handle(this, 1)"                id="doc_time_<?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['time'];?>
</span>
...
" onblur="change_doc_time_handle(this, 2)" />
				...
				<td>
					<span title="点击修改" class="doc_level"  id="doc_level_<?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['id'];?>
" onclick="change_doc_level_handle(this, 1);" ><?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['level'];?>
</span>
...
" onblur="change_doc_level_handle(this, 2)">
				...
				<td>
					<input onclick="change_doc_honnor_leader_handle(this, 1);"  type="checkbox"  <?php if ($_smarty_tpl->tpl_vars['is_finished']->value){?> disabled="true" <?php }?> id="doc_checkbox_leader_<?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['honor_leader']==1){?> checked="checked" <?php }?>  title="荣获带队奖的志愿者将获得额外的志愿时间" />
				...
				<td>
					<input onclick="change_doc_honnor_leader_handle(this, 2);"  type="checkbox"    <?php if ($_smarty_tpl->tpl_vars['is_finished']->value){?> disabled="true" <?php }?> id="doc_checkbox_excellent_<?php echo $_smarty_tpl->tpl_vars['part_doc_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['part_doc_index']['index']]['id'];?>
...
" onclick="change_doc_comment_handle(this, 1)"> 
