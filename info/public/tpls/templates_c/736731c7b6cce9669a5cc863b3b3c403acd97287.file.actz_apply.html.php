<?php /* Smarty version Smarty-3.1.7, created on 2014-03-18 10:02:54
         compiled from "../tpls/templates\include\actz_apply.html" */ ?>
<?php /*%%SmartyHeaderCode:381353280bbe86f629-23133186%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '381353280bbe86f629-23133186',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53280bbf421fb',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53280bbf421fb')) {function content_53280bbf421fb($_smarty_tpl) {?>
...
"><?php echo $_smarty_tpl->tpl_vars['apply_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['vol_index']['index']]['state'];?>
	...
	<?php if ($_smarty_tpl->tpl_vars['show_op_button']->value){?>
		...
		<div id="" class="" style="border-color:red">
			<textarea onchange="textarea_back_reason_on_change(this, false);" id="textarea_back_reason" name="" rows="5" cols="50" ></textarea>
		</div>
...
"  disabled="true" value="退回" title="请先勾选要退回志愿者并填写退回理由"/>
		<input type="button" class="button" id="btn_export_csv" value="导出" actid="<?php echo $_smarty_tpl->tpl_vars['actid']->value;?>
"  title="导出所有审核通过的志愿者到csv"  />
	<?php }else{ ?>
