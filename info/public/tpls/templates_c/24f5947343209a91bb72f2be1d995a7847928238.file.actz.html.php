<?php /* Smarty version Smarty-3.1.7, created on 2014-03-15 12:56:48
         compiled from "../tpls/templates\include\actz.html" */ ?>
<?php /*%%SmartyHeaderCode:2076553244000e960c0-37927677%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2076553244000e960c0-37927677',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_532440022f1db',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_532440022f1db')) {function content_532440022f1db($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'D:\\Xampp\\htdocs\\NjuVolunteer\\info\\Smarty\\libs\\plugins\\modifier.truncate.php';
?>
<div id="" class="" style="margin: 0 20px">
	...
	<table id="show_activity_table" class="act_people_table">
		...
		<th>
			活动名称
			<div style="display:hidden;height:0px;width:350px" ></div>
			</th>
		<th>负责人</th>
		<th>状态</th>
		<th colspan="3" >
			操作
			<div style="display:hidden;height:0px;width:120px" ></div>
		</th>
		</tr>
...
" class="util_doc_add_disabled">
														<img src="./assets/img/zonet/form_yellow_add.png" width="18" height="18" 
														border="0" title="审核未通过或已完成的活动不能添加档案">
													</span>
													<?php }?>
											</td>
										</tr>
