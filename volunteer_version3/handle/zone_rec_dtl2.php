...
<ul id="rec_dtl_ul">
	...
	<li>
		...
		<div id="act_people_div">
			...
			快捷操作<br />
			<input type="button" value="从报名表导入此参与表" disabled="true" /><br />
			<input type="button" value="将选择的志愿者移除该参与表"  disabled="true"/><br />
			<input type="button" value="选择所有未录入服务时间的志愿者"  disabled="true"/><br />
			<input type="button" value="将选择的志愿者设置服务时间为"  disabled="true"/>
